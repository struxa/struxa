...
final class ContentEntrySectionStore implements SectionStoreInterface
{
    public function __construct(private readonly ContentEntrySectionRepository $repo)
    {
    }

    public function list(int $subjectId): array
    {
        return $this->repo->listForEntry($subjectId);
    }
    ...
    {
        return $this->repo->belongsToEntry($sectionId, $subjectId);
    }
    ...
    {
        $this->repo->reorderForEntry($subjectId, $idsInOrder);
    }
