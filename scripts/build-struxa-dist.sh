...
echo "==> Done. Dev copy synced to public/struxa-dist/ for local testing."
echo "    Production StruxaPoint catalog is generated by struxa-admin (Admin → Regenerate)."
echo "    CMS updates do NOT overwrite live repo.json or zips/ on the server."
