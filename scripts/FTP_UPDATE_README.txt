...
It does NOT include the live StruxaPoint catalog under public/struxa-dist/
(repo.json, repo-summary.json, publish.json, news.json, zips/, catalog/ shards).
On struxapoint.com those files are generated by the struxa-admin plugin after
approving package submissions — CMS updates must not overwrite them.
