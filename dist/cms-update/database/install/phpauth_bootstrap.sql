-- Idempotent PHPAuth tables for fresh MySQL (no DROP). Used by public/install.php when phpauth_* is missing.
-- Charset aligned with CMS migrations (utf8mb4).
...
INSERT IGNORE INTO `phpauth_config` (`setting`, `value`) VALUES
  ...
  ('site_email', 'no-reply@localhost'),
  ('site_key', 'replace-via-env'),
  ('site_name', 'Struxa'),
...
CREATE TABLE IF NOT EXISTS `phpauth_requests` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `token` CHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `expire` datetime NOT NULL,
  `type` ENUM('activation','reset') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `type` (`type`),
  KEY `token` (`token`),
  KEY `uid` (`uid`)
...
CREATE TABLE IF NOT EXISTS `phpauth_sessions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `hash` char(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `expiredate` datetime NOT NULL,
  `ip` varchar(39) NOT NULL,
  `device_id` varchar(36) DEFAULT NULL,
  `agent` varchar(200) NOT NULL,
  `cookie_crc` char(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
