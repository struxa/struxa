...
**Version:** 1.1.14 (canonical: `composer.json` → `version`)
...
- **Plugins** and **non-default themes** are not in this git repo; install from **Admin → Browse catalog** (`struxa-dist/` + struxapoint.com). Only **`themes/struxa-theme/`** ships with core.
